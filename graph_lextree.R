...
#    ylab("Mean KL-divergence") + xlab("Sample size") + theme_bw() + theme(legend.position=c(0.765, 0.74), legend.background = element_rect(fill=alpha('white', 0))) +theme(plot.margin=unit(c(1,5,1,5),"mm"))
  ylab("Mean KL-divergence") + xlab("Sample size") + theme_bw() + theme(legend.position=c(0.28, 0.28), legend.background = element_rect(fill=alpha('white', 0))) +theme(plot.margin=unit(c(1,5,1,1),"mm"))
  +geom_line(aes(y=var1$V2, colour="Unpruned LP-tree"), colour="springgreen4", linetype="solid") + geom_point(aes(y=var1$V2, shape="Unpruned LP-tree"), colour="springgreen4", fill="springgreen4") 
  ...
  + scale_colour_manual(name = 'Legend', guide = 'legend',
                        limits = c(NULL
                                   ,'Unpruned LP-tree' #courbe1
                                   ,'Pruned LP-tree' #1_2
                                   ,'Linear LP-tree' #1_4
                        ),
                        values =c(NULL
                                  ,'Unpruned LP-tree'='springgreen4' #courbe1
...
(ggplot(NULL, aes(var1$V1)) + scale_y_log10() + scale_x_log10() + annotation_logticks(sides="lb") +
    ylab("Mean learning time (ms)") + xlab("Sample size") + theme_bw() + theme(legend.position=c(0.3, 0.72), legend.background = element_rect(fill=alpha('white', 0))) +theme(plot.margin=unit(c(1,1,1,5),"mm"))
  +geom_line(aes(y=var1$V2, colour="Unpruned LP-tree"), colour="springgreen4", linetype="solid") + geom_point(aes(y=var1$V2, shape="Unpruned LP-tree"), colour="springgreen4", fill="springgreen4") 
  +geom_line(aes(y=var2$V2, colour="Pruned LP-tree"), colour="firebrick3", linetype="solid") + geom_point(aes(y=var2$V2, shape="Pruned LP-tree"), colour="firebrick3", fill="firebrick3") 
  +geom_line(aes(y=var3$V2, colour="Linear LP-tree"), colour="black", linetype="solid") + geom_point(aes(y=var3$V2, shape="Linear LP-tree"), colour="black", fill="black") 
  + scale_colour_manual(name = 'Legend', guide = 'legend',
...
(ggplot(NULL, aes(var1$V1)) + scale_y_log10() + scale_x_log10() + annotation_logticks(sides="lb") +
    ylab("Mean size") + xlab("Sample size") + theme_bw() + theme(legend.position=c(0.3, 0.72), legend.background = element_rect(fill=alpha('white', 0))) +theme(plot.margin=unit(c(1,5,1,5),"mm"))
  +geom_line(aes(y=var1$V2, colour="Unpruned LP-tree"), colour="springgreen4", linetype="solid") + geom_point(aes(y=var1$V2, shape="Unpruned LP-tree"), colour="springgreen4", fill="springgreen4") 
  +geom_line(aes(y=var2$V2, colour="Pruned LP-tree"), colour="firebrick3", linetype="solid") + geom_point(aes(y=var2$V2, shape="Pruned LP-tree"), colour="firebrick3", fill="firebrick3") 
  +geom_line(aes(y=var3$V2, colour="Linear LP-tree"), colour="black", linetype="solid") + geom_point(aes(y=var3$V2, shape="Linear LP-tree"), colour="black", fill="black") 
  + scale_colour_manual(name = 'Legend', guide = 'legend',
