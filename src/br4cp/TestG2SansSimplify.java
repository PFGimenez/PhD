...
public class TestG2SansSimplify implements TestIndependance {
...
//		double distance;
		...
		for(int i=0; i<v.size(); i++){
			...
			for(int j=i+1; j<v.size(); j++){
				...
				double[] sommeV1 = new double[dom1];
				double[] sommeV2 = new double[dom2];
				...
				variance[i][j] = pochisq(statistique, (dom1-1)*(dom2-1));
