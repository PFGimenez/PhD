...
import java.io.*;
	...
	public class SALADD implements Configurator {		
		 ...
		 */
		public void compilation(String file_name, boolean arg_plus, Heuristique arg_heuristique, HeuristiqueContraintes arg_heuristique_cons, int arg_affich_text){
		 ...
		 * @param arg_affich_text : niveau d'affichage de texte sur la sortie standard. De 0 (pas de texte) à 3 (beaucoup de texte)
		 */
		public void compilation(ArrayList<String> file_names, boolean arg_plus, Heuristique arg_heuristique, HeuristiqueContraintes arg_heuristique_cons, int arg_affich_text){
...
//			xml.reorganiseContraintes(0);
		...
		public void procedureCompilation(ArrayList<String> FichiersACompiler, boolean arg_plus, Heuristique arg_heuristique, HeuristiqueContraintes arg_heuristique_cons, String arg_formefinale, String arg_FichierSortie, boolean flag_fichierSortie, boolean flag_beg, int arg_affich_text){
	    			...
	    			if(x==null || inX.compareTo(problemNamePriceornot)!=0){
	    				...
	    				if(f.canRead()){
	    					...
	    					if(!priced && problemName.compareTo("big")==0){										//si big unpricced, alors heuristique 3
	    						procedureCompilation(pbnames, true, new HeuristiqueMCSinv(), new HeuristiqueContraintesDomaineMaxDomaineMaxEcartMaxHardFirst(), "", (problemNamePriceornot+"_compiled"), true, true, 0);
	    					}else{																				//sinon heuristique 5
	    						procedureCompilation(pbnames, true, new HeuristiqueMCSinvPlusUn(), new HeuristiqueContraintesDomaineMaxDomaineMaxEcartMaxHardFirst(), "", (problemNamePriceornot+"_compiled"), true, true, 0);
	    					}
