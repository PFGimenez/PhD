...
public class LexicographicOrder
{
	...
	public LexicographicOrder(String variable, int nbMod, LexicographicOrder enfant)
	{
		this.nbMod = nbMod;
	...
	public int getPref(String valeur)
	{
	...
	public long updateBase()
	{
//		System.out.println(variable);
		if(enfant == null)
			base = 1;
		else
			base = enfant.updateBase();
//		System.out.println("Base de "+variable+" : "+base);
		return base*nbMod;
	}
	...
	public LexicographicOrder getEnfant()
	{
		return enfant;
	}
