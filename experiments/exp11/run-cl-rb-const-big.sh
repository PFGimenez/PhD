...
(cd ../.. ; ./run.sh Recom2 cluster 1 jointree mmhc datasets/renault_big 10 -e -c datasets/renault_big/contraintes.xml -s 10 | tee experiments/exp11/jointree-cl1-const-big)
(cd ../.. ; ./run.sh Recom2 cluster 2 jointree mmhc datasets/renault_big 10 -e -c datasets/renault_big/contraintes.xml -s 10 | tee experiments/exp11/jointree-cl2-const-big)
(cd ../.. ; ./run.sh Recom2 cluster 3 jointree mmhc datasets/renault_big 10 -e -c datasets/renault_big/contraintes.xml -s 10 | tee experiments/exp11/jointree-cl3-const-big)
